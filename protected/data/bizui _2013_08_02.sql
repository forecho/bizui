...
INSERT INTO `bz_comments` (`bc_id`, `bp_id`, `bu_id`, `bc_text`, `bc_status`, `bc_parent`, `bc_like`, `bc_create_time`) VALUES
(1, 14, 1, '好的', 1, 0, 1, 0),
(5, 14, 1, 'Thx', 1, 0, 1, 1375417084);
