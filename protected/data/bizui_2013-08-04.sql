...
# Database: bizui
# Generation Time: 2013-08-04 02:19:49 +0000
# ************************************************************
...
LOCK TABLES `bz_comments` WRITE;
/*!40000 ALTER TABLE `bz_comments` DISABLE KEYS */;

INSERT INTO `bz_comments` (`bc_id`, `bp_id`, `bu_id`, `bc_text`, `bc_status`, `bc_parent`, `bc_like`, `bc_create_time`, `bc_path`)
VALUES
	(1,14,1,'好的',1,0,1,1375454994,'0'),
	(5,14,1,'Thx',1,0,1,1375417084,'0'),
	(6,12,1,'mark',1,0,1,1375454994,'0'),
	(7,12,1,'收藏',1,0,1,1375455017,'0'),
	(8,10,1,'收藏',1,0,1,1375455028,'0'),
	(9,14,1,'你好的哦\r\n\r\n好的',1,0,1,1375455017,'0'),
	(10,14,1,'你好',1,1,1,1375546797,'0-1'),
	(11,14,1,'不错',1,10,1,1375581806,'0-1-10'),
	(12,14,1,'嗯',1,1,1,1375582109,'0-1');

/*!40000 ALTER TABLE `bz_comments` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `bz_save` (`id`, `bu_id`, `bp_id`, `type`)
VALUES
	(1,1,14,1),
	(2,1,12,1);
